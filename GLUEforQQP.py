...
#     ds = ds.map(lambda example: tokenizer(example["question1"], example["question2"], truncation=True, padding="max_length"), batched=True)
#     ds.set_format(
...
def get_torch_dataset(tokenizer : AutoTokenizer,which = "qqp", **kwargs):
